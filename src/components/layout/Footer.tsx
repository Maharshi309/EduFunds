        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-300 text-sm">
              Empowering Indian students with comprehensive scholarship information to pursue their educational dreams.
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/scholarships" className="text-gray-300 hover:text-white text-sm">
                  Scholarships
                </Link>
              </li>
              <li>
                <Link to="/universities" className="text-gray-300 hover:text-white text-sm">
                  Universities
                </Link>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-gray-300 text-sm">support@edufunds.in</span>
              </li>
              <li className="flex items-start">
